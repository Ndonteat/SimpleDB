...
public class HeapPage implements Page {
    ...
    */
    private int getNumTuples() {        
        // some code goes here
        return (int) Math.floor(Database.getBufferPool().getPageSize() * 8) /(this.td.getSize() * 8 + 1);
    ...
    private int getHeaderSize() {        
        ...
        // some code goes here
        return (int) Math.ceil(1.0 * this.getNumTuples() / 8);
...
//        System.out.println(numSlots);
        ...
        if (t.getRecordId().getPageId() != this.pid){
            System.out.println("here went wrong" + "\n");
            throw new DbException("tuple not on this page");
        }

//        System.out.println(this.tuples[0]);
//        System.out.println(t);
//        System.out.println(this.tuples[1]);
//        System.out.println(t);

//        for (int i = 0; i < numSlots; i++){
//            System.out.println("the " + i + "th slot is used  " + this.isSlotUsed(i));
//           System.out.println("the "+ i + "th tuple is     " + this.tuples[i]);
//           System.out.println("the tuple to delete is " + t);
//
...
//        }
        ...
        if (i < 0 || i > this.tuples.length - 1) {
            throw new DbException("i is not in the range");
        }

        if (this.tuples[i] == null) {
            throw new DbException("the i th tuple is null");
        }
...
//        System.out.println("(HeapPage)tuple tp be deleted is " + t);
//        if (!isSlotUsed(tupleno)) {
//            throw new DbException("Tuple slot is already empty");
//        }
//
//        System.out.println("(HeapPage)deleted");
//        tuples[tupleno] = null;
//        markSlotUsed(tupleno, false);
    ...
    public boolean isSlotUsed(int i) {
        ...
        int num = i / 8;
        int position = i % 8;
        return (((header[num]) >> position) & 1) == 1;
    }
    ...
    public Iterator<Tuple> iterator() {
        ...
        for (int i = 0; i < this.numSlots; i++){
            if (this.isSlotUsed(i)){
                this.tupleList.add(this.tuples[i]);
            }
        }
        if (this.tupleList.isEmpty()){
            return null;
        }//Watch here!!!!!!!!!!!!!!!!!!!!!!!!!!!!This have to be handled otherwise there would be an error
        //in DeleteTest!!!!!!!!!!!!!!!!

        return tupleList.iterator();
        //return Collections.unmodifiableCollection(this.tupleList).iterator();
    }
