...
**Milestone Due: Friday, March 13th, 2020**

**Final Due: Thursday, March 19th, 2020**
...
You should begin with the code you submitted for **Lab 4**, but if you are concerned that your Lab 4 does not work correctly you may also rollback to Lab 3 and this shouldn't cause problems.
...
>>>>>>> 35beb69aa5ce52b15bc8fa2b15a280de203a1283
...
#### Exercise 1 (45% of tests grade)

Complete the implementation of the Worker.java class.

**Important**: To pass the next test, you also need to implement the constructor of `ShuffleProducer` and `ShuffleConsumer` as well as their `setChildren` and `getChildren` methods. You do not need to implement the other methods until exercise 2.

You should now be able to pass the WorkerTest.

Use the startSimpleDB.sh script to execute the following parallel selection query on the 1% (and optionally also the 10%) sample of the IMDB database.
...
Push your code for Exercise 1 by the milestone due date. Whether the tests pass will not be graded, but make sure you have added code implementing the methods described above.
...
You must submit your code (see below) as well as the lab writeup containing your answers to the question prompts in each section.

Also comment of the performance of your system generally. Do you observe the speedup you would expect when increasing the number of nodes?
...
**Extra important**: Make sure to put your name in the lab writeup. 

```sh
$ git add lab6-writeup.pdf
```
...
As usual, your total score for the lab will be composed of a grade for the Tests, Code Quality, and Writeup.
**Special note for Winter 2020:** because of the unusual circumstances this quarter, exercise 1 and 2 will we weighted more heavily than exercise 3 as detailed above. So if you aren't able to get all of exercise 3 working perfectly, you will not be penalized more than 10% of the test component. 
